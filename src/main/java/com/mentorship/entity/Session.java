...
// Table name is plural because SESSION is a reserved SQL keyword.
// Unique booking_id is safe here: booking rows are never reused, so a rebooking
// creates a new Booking with its own Session.
@Entity
@Table(name = "sessions")
